...
target_link_libraries(your_target PRIVATE hal_interface::hal_interface)
```

## Implementation

This package only provides interfaces. You must link against a concrete implementation such as `stm_hal` to use these interfaces.
