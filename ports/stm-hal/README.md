...
STM32-specific implementation of the `hal-interface` for embedded GPIO and interrupt control. This package provides concrete implementations of the HAL interfaces for STM32U0xx microcontrollers.
...
find_package(stm-hal CONFIG REQUIRED)
...
- `hal-interface` - Abstract HAL interface
